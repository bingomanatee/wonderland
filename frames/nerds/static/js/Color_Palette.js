(function () {
    ...
    function Color_Palette(thing_canvas, x, y, width, height) {
    ...
    Color_Palette.prototype = {
        ...
        color_choice: function (hue, sat, value) {
            ...
            return _.bind(function (event) {
                ...
                this.show(false);
                this.thing_canvas.set_color(this._color_string(hue, sat, value));
            }, this);
    ...
    NERDS_app.factory('Color_Palette', function () {

        return function (thing_canvas, x, y, width, height) {

            return new Color_Palette(thing_canvas,x, y, width, height);
