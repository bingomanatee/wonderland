...
var count=document.createElement('script');count.type='text/javascript';count.async=true;count.src='//hello.myfonts.net/count/284499';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if(typeof(woffEnabled)=='undefined'){var woffEnabled=true;}
...
suffix="_unhinted";var fonts=[{"fontFamily":"BakerHalfBare-Bold","url":wfpath+"284499_0"+suffix+"_0."+webfontType},{"fontFamily":"BakerHalfBare-Regular","url":wfpath+"284499_1"+suffix+"_0."+webfontType},{"fontFamily":"BakerHalfDozen-Bold","url":wfpath+"284499_2"+suffix+"_0."+webfontType}];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="format(\"svg\")";}
