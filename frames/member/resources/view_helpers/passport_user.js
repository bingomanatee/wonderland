...
Member_Menu.prototype = {
    ...
    render: function (mode) {
        console.log('render passport user with mode %s', mode);
        switch (mode) {
            case 'topnav':
                return topnav_template(this);
                break;
...
var menu_template, topnav_template;

/* ********* EXPORTS ******** */

module.exports = function (apiary, cb) {

    fs.readFile(path.resolve(__dirname, 'templates/topnav.html'), 'utf8', function (err, ttxt) {
        topnav_template = _.template(ttxt);
